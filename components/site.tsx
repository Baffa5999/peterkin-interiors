...
export function Hero({ image }: { image: string }) {
  return <section className="relative flex min-h-[68svh] items-end overflow-hidden bg-muted text-white sm:min-h-[78svh] md:min-h-[92vh]"><Image src={image} alt="Peterkin Interiors living room in Abuja with natural light and warm neutral finishes" fill priority sizes="100vw" className="object-cover" /><div className="absolute inset-0 bg-black/25" /><div className="relative z-10 flex w-full items-end justify-between gap-8 px-5 pb-9 md:px-8 md:pb-12"><div><p className="mb-4 text-[10px] uppercase tracking-[0.24em]">Abuja · Nigeria</p><h1 className="max-w-3xl font-serif text-5xl leading-[0.95] tracking-[-0.04em] md:text-8xl">Spaces with a sense of place.</h1></div><a href="#projects" className="hidden items-center gap-2 pb-1 text-[10px] uppercase tracking-[0.2em] md:flex">Scroll to explore <ArrowDown size={14} /></a></div></section>
}
